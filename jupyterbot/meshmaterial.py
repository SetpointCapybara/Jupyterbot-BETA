...
class MeshMaterial:
    ...
    def __init__(self, opacity=1, shadow_side="null", side="null", alpha_map="", ao_map="", \
        ...
        if not (clearcoat_roughness_map == "" or Utils.get_jupyterbot_type(clearcoat_roughness_map) == "jupyterbot.Texture"):
        ...
        if not (specular_intensity_map == "" or Utils.get_jupyterbot_type(specular_intensity_map) == "jupyterbot.Texture"):
