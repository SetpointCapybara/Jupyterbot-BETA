...
class RobotEnv(gym.Env):
    ...
    def next_observation(self):
        ...
        ds = self.robot.compute_hg_dist(obj=self.obstacle, h=self.h, g=self.h, old_dist_struct=self.oldDistStruct)
        obs = np.zeros((24 + n,))
        envInfo = np.zeros((12,))
    ...
    def reset(self):
        ...
        while not found_config:
            ...
            dist = self.robot.compute_hg_dist(q = q, obj=self.obstacle).get_closest_item()["hgDistance"]
